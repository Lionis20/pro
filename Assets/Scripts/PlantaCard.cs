...
public class PlantaCard : MonoBehaviour
{
    public int Ataque;
    public int Defensa;
    ...
    public void RevitalizarPlayer()
    {
        if(gameObject.CompareTag("MS") && gameObject.layer == LayerMask.NameToLayer("Player"))
        {
            Ataque += 2;
            Defensa += 2;
        }
    ...
    public void RevitalizarPlayer2()
    {
        if(gameObject.CompareTag("MS") && gameObject.layer == LayerMask.NameToLayer("Player2"))
        {
            Ataque += 2;
            Defensa += 2;
        }
